...
/**
 * @author Les cravates
 * @copyright © 2016 Cégep-ste-foy. Tous droits réservés.
 * Date: 2015-02-11
 * Cette page se connecte à la base de données
 */
...
// DEBUT Paramètres du site
    ...
    $strCourrielContact= 'laurence.fg@live.fr'; //VOTRE adresse courriel VALIDE. Sinon, à répétition, cela bloque le serveur de courriel du cegep entier!
